 ...
 *
 * Ported byte-for-byte from `packages/web/src/components/AppLogo.tsx` — the two apps must not
 * drift on the one asset that says whose product this is. Only the colour token changes:
